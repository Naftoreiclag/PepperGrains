        ...
        void queryInstanceSpecific() {
            ...
            for(const VkPhysicalDevice& device : mPhysicalDevices) {
                ...
                vout.indent();
                    ...
                    vout << "standardSampleLocations: "                         << limits.standardSampleLocations << std::endl;
                    vout << "strictLines: "                                     << limits.strictLines << std::endl;
                    vout << "timestampComputeAndGraphics: "                     << limits.timestampComputeAndGraphics << std::endl;
                    vout << "bufferImageGranularity: "                          << limits.bufferImageGranularity << std::endl;
                    vout << "minStorageBufferOffsetAlignment: "                 << limits.minStorageBufferOffsetAlignment << std::endl;
                    vout << "minTexelBufferOffsetAlignment: "                   << limits.minTexelBufferOffsetAlignment << std::endl;
                    vout << "minUniformBufferOffsetAlignment: "                 << limits.minUniformBufferOffsetAlignment << std::endl;
                    vout << "nonCoherentAtomSize: "                             << limits.nonCoherentAtomSize << std::endl;
                    vout << "optimalBufferCopyOffsetAlignment: "                << limits.optimalBufferCopyOffsetAlignment << std::endl;
                    vout << "optimalBufferCopyRowPitchAlignment: "              << limits.optimalBufferCopyRowPitchAlignment << std::endl;
                    vout << "sparseAddressSpaceSize: "                          << limits.sparseAddressSpaceSize << std::endl;
                    vout << "framebufferColorSampleCounts: "                    << limits.framebufferColorSampleCounts << std::endl;
                    vout << "framebufferDepthSampleCounts: "                    << limits.framebufferDepthSampleCounts << std::endl;
                    vout << "framebufferNoAttachmentsSampleCounts: "            << limits.framebufferNoAttachmentsSampleCounts << std::endl;
                    vout << "framebufferStencilSampleCounts: "                  << limits.framebufferStencilSampleCounts << std::endl;
                    vout << "sampledImageColorSampleCounts: "                   << limits.sampledImageColorSampleCounts << std::endl;
                    vout << "sampledImageDepthSampleCounts: "                   << limits.sampledImageDepthSampleCounts << std::endl;
                    vout << "sampledImageIntegerSampleCounts: "                 << limits.sampledImageIntegerSampleCounts << std::endl;
                    vout << "sampledImageStencilSampleCounts: "                 << limits.sampledImageStencilSampleCounts << std::endl;
                    vout << "storageImageSampleCounts: "                        << limits.storageImageSampleCounts << std::endl;
                    vout << "lineWidthGranularity: "                            << limits.lineWidthGranularity << std::endl;
                    vout << "lineWidthRange[0]: "                               << limits.lineWidthRange[0] << std::endl;
                    vout << "lineWidthRange[1]: "                               << limits.lineWidthRange[1] << std::endl;
                    vout << "maxInterpolationOffset: "                          << limits.maxInterpolationOffset << std::endl;
                    vout << "maxSamplerAnisotropy: "                            << limits.maxSamplerAnisotropy << std::endl;
                    vout << "maxSamplerLodBias: "                               << limits.maxSamplerLodBias << std::endl;
                    vout << "minInterpolationOffset: "                          << limits.minInterpolationOffset << std::endl;
                    vout << "pointSizeGranularity: "                            << limits.pointSizeGranularity << std::endl;
                    vout << "pointSizeRange[0]: "                               << limits.pointSizeRange[0] << std::endl;
                    vout << "pointSizeRange[1]: "                               << limits.pointSizeRange[1] << std::endl;
                    vout << "timestampPeriod: "                                 << limits.timestampPeriod << std::endl;
                    vout << "viewportBoundsRange[0]: "                          << limits.viewportBoundsRange[0] << std::endl;
                    vout << "viewportBoundsRange[1]: "                          << limits.viewportBoundsRange[1] << std::endl;
                    vout << "minTexelGatherOffset: "                            << limits.minTexelGatherOffset << std::endl;
                    vout << "minTexelOffset: "                                  << limits.minTexelOffset << std::endl;
                    vout << "minMemoryMapAlignment: "                           << limits.minMemoryMapAlignment << std::endl;
                    vout << "discreteQueuePriorities: "                         << limits.discreteQueuePriorities << std::endl;
                    vout << "maxBoundDescriptorSets: "                          << limits.maxBoundDescriptorSets << std::endl;
                    vout << "maxClipDistances: "                                << limits.maxClipDistances << std::endl;
                    vout << "maxColorAttachments: "                             << limits.maxColorAttachments << std::endl;
                    vout << "maxCombinedClipAndCullDistances: "                 << limits.maxCombinedClipAndCullDistances << std::endl;
                    vout << "maxComputeSharedMemorySize: "                      << limits.maxComputeSharedMemorySize << std::endl;
                    vout << "maxComputeWorkGroupCount[0]: "                     << limits.maxComputeWorkGroupCount[0] << std::endl;
                    vout << "maxComputeWorkGroupCount[1]: "                     << limits.maxComputeWorkGroupCount[1] << std::endl;
                    vout << "maxComputeWorkGroupCount[2]: "                     << limits.maxComputeWorkGroupCount[2] << std::endl;
                    vout << "maxComputeWorkGroupInvocations: "                  << limits.maxComputeWorkGroupInvocations << std::endl;
                    vout << "maxComputeWorkGroupSize[0]: "                      << limits.maxComputeWorkGroupSize[0] << std::endl;
                    vout << "maxComputeWorkGroupSize[1]: "                      << limits.maxComputeWorkGroupSize[1] << std::endl;
                    vout << "maxComputeWorkGroupSize[2]: "                      << limits.maxComputeWorkGroupSize[2] << std::endl;
                    vout << "maxCullDistances: "                                << limits.maxCullDistances << std::endl;
                    vout << "maxDescriptorSetInputAttachments: "                << limits.maxDescriptorSetInputAttachments << std::endl;
                    vout << "maxDescriptorSetSampledImages: "                   << limits.maxDescriptorSetSampledImages << std::endl;
                    vout << "maxDescriptorSetSamplers: "                        << limits.maxDescriptorSetSamplers << std::endl;
                    vout << "maxDescriptorSetStorageBuffers: "                  << limits.maxDescriptorSetStorageBuffers << std::endl;
                    vout << "maxDescriptorSetStorageBuffersDynamic: "           << limits.maxDescriptorSetStorageBuffersDynamic << std::endl;
                    vout << "maxDescriptorSetStorageImages: "                   << limits.maxDescriptorSetStorageImages << std::endl;
                    vout << "maxDescriptorSetUniformBuffers: "                  << limits.maxDescriptorSetUniformBuffers << std::endl;
                    vout << "maxDescriptorSetUniformBuffersDynamic: "           << limits.maxDescriptorSetUniformBuffersDynamic << std::endl;
                    vout << "maxDrawIndexedIndexValue: "                        << limits.maxDrawIndexedIndexValue << std::endl;
                    vout << "maxDrawIndirectCount: "                            << limits.maxDrawIndirectCount << std::endl;
                    vout << "maxFragmentCombinedOutputResources: "              << limits.maxFragmentCombinedOutputResources << std::endl;
                    vout << "maxFragmentDualSrcAttachments: "                   << limits.maxFragmentDualSrcAttachments << std::endl;
                    vout << "maxFragmentInputComponents: "                      << limits.maxFragmentInputComponents << std::endl;
                    vout << "maxFragmentOutputAttachments: "                    << limits.maxFragmentOutputAttachments << std::endl;
                    vout << "maxFramebufferHeight: "                            << limits.maxFramebufferHeight << std::endl;
                    vout << "maxFramebufferLayers: "                            << limits.maxFramebufferLayers << std::endl;
                    vout << "maxFramebufferWidth: "                             << limits.maxFramebufferWidth << std::endl;
                    vout << "maxGeometryInputComponents: "                      << limits.maxGeometryInputComponents << std::endl;
                    vout << "maxGeometryOutputComponents: "                     << limits.maxGeometryOutputComponents << std::endl;
                    vout << "maxGeometryOutputVertices: "                       << limits.maxGeometryOutputVertices << std::endl;
                    vout << "maxGeometryShaderInvocations: "                    << limits.maxGeometryShaderInvocations << std::endl;
                    vout << "maxGeometryTotalOutputComponents: "                << limits.maxGeometryTotalOutputComponents << std::endl;
                    vout << "maxImageArrayLayers: "                             << limits.maxImageArrayLayers << std::endl;
                    vout << "maxImageDimension1D: "                             << limits.maxImageDimension1D << std::endl;
                    vout << "maxImageDimension2D: "                             << limits.maxImageDimension2D << std::endl;
                    vout << "maxImageDimension3D: "                             << limits.maxImageDimension3D << std::endl;
                    vout << "maxImageDimensionCube: "                           << limits.maxImageDimensionCube << std::endl;
                    vout << "maxMemoryAllocationCount: "                        << limits.maxMemoryAllocationCount << std::endl;
                    vout << "maxPerStageDescriptorInputAttachments: "           << limits.maxPerStageDescriptorInputAttachments << std::endl;
                    vout << "maxPerStageDescriptorSampledImages: "              << limits.maxPerStageDescriptorSampledImages << std::endl;
                    vout << "maxPerStageDescriptorSamplers: "                   << limits.maxPerStageDescriptorSamplers << std::endl;
                    vout << "maxPerStageDescriptorStorageBuffers: "             << limits.maxPerStageDescriptorStorageBuffers << std::endl;
                    vout << "maxPerStageDescriptorStorageImages: "              << limits.maxPerStageDescriptorStorageImages << std::endl;
                    vout << "maxPerStageDescriptorUniformBuffers: "             << limits.maxPerStageDescriptorUniformBuffers << std::endl;
                    vout << "maxPerStageResources: "                            << limits.maxPerStageResources << std::endl;
                    vout << "maxPushConstantsSize: "                            << limits.maxPushConstantsSize << std::endl;
                    vout << "maxSampleMaskWords: "                              << limits.maxSampleMaskWords << std::endl;
                    vout << "maxSamplerAllocationCount: "                       << limits.maxSamplerAllocationCount << std::endl;
                    vout << "maxStorageBufferRange: "                           << limits.maxStorageBufferRange << std::endl;
                    vout << "maxTessellationControlPerPatchOutputComponents: "  << limits.maxTessellationControlPerPatchOutputComponents << std::endl;
                    vout << "maxTessellationControlPerVertexInputComponents: "  << limits.maxTessellationControlPerVertexInputComponents << std::endl;
                    vout << "maxTessellationControlPerVertexOutputComponents: " << limits.maxTessellationControlPerVertexOutputComponents << std::endl;
                    vout << "maxTessellationControlTotalOutputComponents: "     << limits.maxTessellationControlTotalOutputComponents << std::endl;
                    vout << "maxTessellationEvaluationInputComponents: "        << limits.maxTessellationEvaluationInputComponents << std::endl;
                    vout << "maxTessellationEvaluationOutputComponents: "       << limits.maxTessellationEvaluationOutputComponents << std::endl;
                    vout << "maxTessellationGenerationLevel: "                  << limits.maxTessellationGenerationLevel << std::endl;
                    vout << "maxTessellationPatchSize: "                        << limits.maxTessellationPatchSize << std::endl;
                    vout << "maxTexelBufferElements: "                          << limits.maxTexelBufferElements << std::endl;
                    vout << "maxTexelGatherOffset: "                            << limits.maxTexelGatherOffset << std::endl;
                    vout << "maxTexelOffset: "                                  << limits.maxTexelOffset << std::endl;
                    vout << "maxUniformBufferRange: "                           << limits.maxUniformBufferRange << std::endl;
                    vout << "maxVertexInputAttributeOffset: "                   << limits.maxVertexInputAttributeOffset << std::endl;
                    vout << "maxVertexInputAttributes: "                        << limits.maxVertexInputAttributes << std::endl;
                    vout << "maxVertexInputBindingStride: "                     << limits.maxVertexInputBindingStride << std::endl;
                    vout << "maxVertexInputBindings: "                          << limits.maxVertexInputBindings << std::endl;
                    vout << "maxVertexOutputComponents: "                       << limits.maxVertexOutputComponents << std::endl;
                    vout << "maxViewportDimensions[0]: "                        << limits.maxViewportDimensions[0] << std::endl;
                    vout << "maxViewportDimensions[1]: "                        << limits.maxViewportDimensions[1] << std::endl;
                    vout << "maxViewports: "                                    << limits.maxViewports << std::endl;
                    vout << "mipmapPrecisionBits: "                             << limits.mipmapPrecisionBits << std::endl;
                    vout << "subPixelInterpolationOffsetBits: "                 << limits.subPixelInterpolationOffsetBits << std::endl;
                    vout << "subPixelPrecisionBits: "                           << limits.subPixelPrecisionBits << std::endl;
                    vout << "subTexelPrecisionBits: "                           << limits.subTexelPrecisionBits << std::endl;
                    vout << "viewportSubPixelBits: "                            << limits.viewportSubPixelBits << std::endl;
                    #endif // !NDEBUG
                vout.unindent();
            }
            vout.unindent();
