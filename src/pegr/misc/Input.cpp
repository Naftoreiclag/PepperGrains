...
Scancode scancodeFromSDLMouse(uint8_t button) {
    switch(button) {
        case SDL_BUTTON_LEFT    : return Scancode::M_LEFT;
        case SDL_BUTTON_RIGHT   : return Scancode::M_RIGHT;
        case SDL_BUTTON_MIDDLE  : return Scancode::M_MIDDLE;
        case SDL_BUTTON_X1      : return Scancode::M_SPECIAL_0;
        case SDL_BUTTON_X2      : return Scancode::M_SPECIAL_1;
        default : return Scancode::UNKNOWN;
    }
}
#endif
...
Scancode scancodeFromGLFWMouse(int button) {
    switch(button) {
        ...
        case GLFW_MOUSE_BUTTON_MIDDLE   : return Scancode::M_MIDDLE; // GLFW_MOUSE_BUTTON_3
        case GLFW_MOUSE_BUTTON_4        : return Scancode::M_SPECIAL_0;
        case GLFW_MOUSE_BUTTON_5        : return Scancode::M_SPECIAL_1;
        case GLFW_MOUSE_BUTTON_6        : return Scancode::M_SPECIAL_2;
        case GLFW_MOUSE_BUTTON_7        : return Scancode::M_SPECIAL_3;
        case GLFW_MOUSE_BUTTON_8        : return Scancode::M_SPECIAL_4;
        default : return Scancode::UNKNOWN;
    }
}
#endif
